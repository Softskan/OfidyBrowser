...
import com.ofidy.ofidybrowser.database.BookmarkLocalSync;
...
import com.ofidy.ofidybrowser.utils.Preconditions;
...
public class BookmarkSettingsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
        ...
        switch (preference.getKey()) {
            ...
            case SETTINGS_IMPORT_BROWSER:
                getSync().getSupportedBrowsers().subscribeOn(Schedulers.worker())
                        .observeOn(Schedulers.main()).subscribe(new OnSubscribe<List<BookmarkLocalSync.Source>>() {
                    @Override
                    public void onNext(@Nullable List<BookmarkLocalSync.Source> items) {
    ...
    @NonNull
    private List<String> buildTitleList(@NonNull Activity activity, @NonNull List<BookmarkLocalSync.Source> items) {
        List<String> titles = new ArrayList<>();
        String title;
        for (BookmarkLocalSync.Source source : items) {
            switch (source) {
                case STOCK:
