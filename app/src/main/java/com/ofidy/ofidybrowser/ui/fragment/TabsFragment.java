...
import com.ofidy.ofidybrowser.ui.fragment.anim.HorizontalItemAnimator;
import com.ofidy.ofidybrowser.ui.fragment.anim.VerticalItemAnimator;
import com.ofidy.ofidybrowser.ui.view.BackgroundDrawable;
...
public class TabsFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener, TabsView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mShowInNavigationDrawer) {
            ...
            Button viewCart = (Button) view.findViewById(R.id.action_view_cart);
            ...
            Button add = (Button) view.findViewById(R.id.action_add_cart);
            add.setOnClickListener(this);
            View logo = view.findViewById(R.id.logo);
            logo.setOnClickListener(this);
            //if(AppState.getInstance(getContext()).getBoolean(AppState.Key.LOGGED_IN)) {
                TextView textView = (TextView) view.findViewById(R.id.name);
                textView.setText(UserPrefs.getInstance(getContext()).getString(UserPrefs.Key.FIRST_NAME)+ " " +
                        UserPrefs.getInstance(getContext()).getString(UserPrefs.Key.LAST_NAME));
                textView = (TextView) view.findViewById(R.id.email);
                textView.setText(UserPrefs.getInstance(getContext()).getString(UserPrefs.Key.EMAIL));
    ...
    public void onClick(@NonNull View v) {
        switch (v.getId()) {
            ...
            case R.id.action_add_cart:
                mUiController.onAddToCartClicked();
                break;
            case R.id.logo:
                mUiController.onHomeButtonPressed();
                break;
            case R.id.action_view_cart:
                mUiController.onCartButtonPressed();
                //mUiController.
            ...
            case R.id.action_logout:
                final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                        .setTitle("Sign out?")
                        .setMessage("Are you sure you want to sign out of this application")
                        ...
                        .setNegativeButton("Yes", (dialog, which) -> {
                            ...
                            AppState.getInstance(getActivity()).setBoolean(AppState.Key.LOGGED_IN, false);
                            getActivity().finish();
                        })
                        .create();
                alertDialog.show();
